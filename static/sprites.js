...
window.SP = (() => {
  ...
  const F = {
    ...
    '9': '111101111001110', ' ': '000000000000000', '!': '010010010000010', '"': '101101000000000', '#': '101111101111101',
    '$': '010111110011111', '%': '101001010100101', '&': '010101010101011', "'": '010010000000000', '(': '001010010010001',
    ')': '100010010010100', '*': '000101010101000', '+': '000010111010000', ',': '000000000010100', '-': '000000111000000',
    '.': '000000000000010', '/': '001001010100100', ':': '000010000010000', ';': '000010000010100', '<': '001010100010001',
    '=': '000111000111000', '>': '100010001010100', '?': '110001010000010', '@': '111101111100011', '[': '011010010010011', '\\': '100100010001001',
    ']': '110010010010110', '^': '010101000000000', '_': '000000000000111', '`': '100010000000000', '{': '001010110010001',
    '|': '010010010010010', '}': '100010011010100', '~': '000010101000000',
    '…': '000000000000101',
  };
  const normalizeText = str => String(str).normalize('NFKD').replace(/[\u0300-\u036f]/g, '')
  ...
  const textW = (str, s = 1) => [...normalizeText(str)].length * 4 * s - s;
